<?php
include"koneksi.php";
$q=mysql_query("select * from tb_transaksi where status='baru';",$c) or die (mysql_error());
echo"
<html>
<head><title>Pesanan</title></head>
<body background='gambar/desktopadmin.png'>
	<center><table style='width:560px;' cellpadding='0' cellspacing='0'>
	<tr>
	<td colspan='2' style='background-color:#ADFF2F;'>
	<p><img src='gambar/hadmin.png' height='65px' width='800px'></p>
	</td>
	</tr>
	<tr>
...
<tr>
	...
	<td>".$r['ukuran']."</td>
	<td>".$r['total']."</td>
	<td><a href='kirim.php?id=".$r['id_transaksi']."'><input type='button' value='Kirim'></a></td>
	</tr>
";
}
echo"
		...
		<p><img src='gambar/fadm.png' height='65px' width='800px'></p>
		</td>
		</tr>
		</table>
